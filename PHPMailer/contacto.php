...
$mail->Username = 'brend9426@gmail.com';                 // SMTP username
$mail->Password = 'Brm199426';                           // SMTP password
$mail->SMTPSecure = 'ssl';                           // Enable TLS encryption, `ssl` also accepted
$mail->Port = 465;                                    // TCP port to connect to

// Mail que envia y valida el envio del formulario
$mail->setFrom('brend9426@gmail.com', 'Contacto');

$mail->addAddress($destino, 'Ventas');
//Agrego mas destinos en caso de requerirlo
$mail->addAddress($destino2, 'Brenda');
